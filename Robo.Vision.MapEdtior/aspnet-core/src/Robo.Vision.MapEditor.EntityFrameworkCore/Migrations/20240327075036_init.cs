...
namespace Robo.Vision.MapEditor.Migrations
{
    /// <inheritdoc />
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MapName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    MapVersion = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    MapProject = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    MapJsonStr = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
                    MapServiceUrl = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMapDatas", x => x.Id);
                });

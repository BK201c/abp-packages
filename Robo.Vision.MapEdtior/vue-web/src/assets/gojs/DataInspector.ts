...
export class Inspector {
   ...
   * @return {boolean}
   */
  public static showIfNode(part: go.Part): boolean {
   ...
   * @return {boolean}
   */
  public static showIfLink(part: go.Part): boolean {
   ...
   * @return {boolean}
   */
  public static showIfGroup(part: go.Part): boolean {

...
var Stacker = {
  ...
  createNew: function () {
    ...
    /*
        ...
        @int taskid  任务号
         */
    stacker.add = function (tray, column, connect, alt, taskid, code, alarmMessage, initPos, obj) {
      ...
      if (angle == 1) {
        $('#stacker' + id + '').css('background-image', 'url(./images/stacker_1.png)')
      }

      if (angle == 2) {
        $('#stacker' + id + '').css('background-image', 'url(./images/stacker_2.png)')
      }
    ...
    /*
        ...
        @int    movestep   移动缩小比例
         */
    stacker.setPos = function (deviceid, x, y, count, ang, dire, movestep, number = 0) {
      num = number
      id = deviceid
    ...
    stacker.iconAdd = function (column, key, value) {
      ...
      if (key == 'alert' && value > 0) {
        var icon1 =
          ...
          key +
          id +
          '" class="stacker-items" style="width:30px; height:30px;position:absolute;background:url(./images/icon_alert.png) no-repeat;z-index:9000;"></div>'
        map.append(icon1)
        if (angle == 1) {
          $('#stacker' + key + id + '').css({
            x: x + 8 + 'px',
      ...
      if (key == 'connect' && value == 0) {
        var icon2 =
          ...
          key +
          id +
          '" class="stacker-items" style="width:11px; height:11px;position:absolute;background:url(./images/ulink.png) no-repeat;z-index:8500;"></div>'
        map.append(icon2)
      ...
      if (key == 'connect' && value == 1) {
        var icon2 =
          ...
          key +
          id +
          '" class="stacker-items" style="width:11px; height:11px;position:absolute;background:url(./images/link.png) no-repeat;z-index:8500;"></div>'
        map.append(icon2)
        $('#stacker' + key + id + '').css({ x: x + 'px', y: y + 'px' })
      }
      ...
      if (key == 'tray_horizontal' && value == 1) {
        var icon3 =
          ...
          key +
          id +
          '"class="stacker-items" style="width:30px; height:30px;position:absolute;background:url(./images/tray_1.png) no-repeat;z-index:6666;"></div>'
        map.append(icon3)
      ...
      if (key == 'tray_vertical' && value == 1) {
        var icon3 =
          ...
          key +
          id +
          '" class="stacker-items" style="width:30px; height:30px;position:absolute;background:url(./images/tray_2.png) no-repeat;z-index:6666;"></div>'
        map.append(icon3)

    ...
    public partial class Created_Book_Entity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParentId = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "父级权限ID"),
                    ParentPermissionCode = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false, comment: "父级权限编号"),
                    ServiceIdentification = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false, comment: "注册服务实例的前缀"),
                    PermissionCode = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false, comment: "权限编号"),
                    PermissionName = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false, comment: "权限名称"),
                    PermissionNameEn = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false, comment: "权限名称(英文)"),
                    PermissionNameAlias = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false, comment: "权限名称(第三语言)"),
                    DelFlag = table.Column<int>(type: "int", nullable: false, comment: "是否删除--0:未删除;1:已删除"),
                    OrderNo = table.Column<int>(type: "int", nullable: false, comment: "权限顺序"),
                    PermissionType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "权限类型(模块module、菜单menu、按钮button)"),
                    PermissionIcon = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "权限标识，一般指图标"),
                    PermissionDesc = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "权限描述"),
                    ClientRoute = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "路径（菜单权限时使用）"),
                    KeepAliveFlag = table.Column<int>(type: "int", nullable: false, comment: "存活标识"),
                    CreateBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "创建人"),
                    CreationTime = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "创建时间"),
                    UpdateBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "更新人"),
                    LastModificationTime = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "更新时间"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_System_Menu_Grant", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_System_Menu_PermissionCode",
                table: "System_Menu",
                column: "PermissionCode");

            migrationBuilder.CreateIndex(
                name: "IX_System_Menu_Grant_Name_ProviderName_ProviderKey",
                table: "System_Menu_Grant",
                columns: new[] { "Name", "ProviderName", "ProviderKey" });
        }
